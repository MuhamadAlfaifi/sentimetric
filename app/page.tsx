      ...
      <div className="grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-6">
        {tweeps?.filter?.(Boolean).map(({
          ...
          <Card key={i} className="bg-white relative border border-gray-200">
                      ...
                      <div className="flex items-center space-x-reverse space-x-3">
                        <div className="block text-right">
                          <div className="text-sm font-medium text-gray-900">
                            ...
                            <div className="mx-1 text-gray-500 truncate" dir="ltr">@{screen_name}</div>
                ...
                <div className="h-36 flex flex-col">
                  <div className="h-24">
                    <div className="flex space-x-reverse space-x-5">
                      ...
                      <div className="space-y-1">
                        <div className="text-sm text-gray-500">تحليل الرأي</div>
            ...
            <CardActions className="border-t border-t-gray-200 py-2 px-2 flex justify-between items-center">
              <div className="space-x-reverse space-x-2">
                <Link href={`/u/${screen_name}`} className="inline-flex items-center px-2.5 py-1.5 text-base font-medium bg-blue-50 text-blue-500 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                  <span>
                    دخول
                  </span>
                  <svg width="22" height="27.5" viewBox="0 0 100 125" className="fill-blue-500 rotate-180">
                    <g>
                ...
                <Link href={`/edit/${screen_name}`} className="inline-flex items-center px-2.5 py-1.5 text-base font-medium text-blue-500 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                  تعديل
                </Link>
              </div>
              <a href={`https://twitter.com/${screen_name}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center rounded px-2.5 py-1.5 text-base font-medium text-blue-500 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
